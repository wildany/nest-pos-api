...
import { KonsumanIdDto } from 'src/konsumen/dto/create-konsuman.dto';
...
export class PenjualanDto {
  ...
  @ApiProperty({ type: KonsumanIdDto })
  @ValidateNested()
  @IsObject()
  konsumen: KonsumanIdDto;
...
export class penjualanIdDto extends PickType(PenjualanDto, ['id']) {}
